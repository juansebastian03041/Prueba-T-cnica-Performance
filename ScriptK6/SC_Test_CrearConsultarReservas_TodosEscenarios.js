...
export const options = {
  scenarios: {
    // Escenario 1: Poca Concurrencia
    poca_concurrencia: {
      executor: 'ramping-arrival-rate', // Definir el executor para controlar la tasa de llegada.
      startRate: 2, // Tasa inicial de usuarios por segundo.
      timeUnit: '1s', // Unidad de tiempo para la tasa de llegada.
      preAllocatedVUs: 10, // Reservar 10 usuarios virtuales para garantizar capacidad.
      stages: [
        { duration: '1m', target: 10 }, // Ramp-up: Incrementar a 10 usuarios concurrentes en 1 minuto.
        { duration: '5m', target: 10 }, // Mantener 10 usuarios concurrentes por 5 minutos.
      ],
    },
    ...
    carga_moderada: {
      ...
      startTime: '6m', // Iniciar después de que termine el escenario anterior (6 minutos).
    },
    // Escenario 3: Alta Concurrencia
    alta_concurrencia: {
      executor: 'ramping-arrival-rate', // Usar el mismo tipo de executor.
      startRate: 20, // Tasa inicial de usuarios por segundo.
      timeUnit: '1s', // Unidad de tiempo para la tasa de llegada.
      preAllocatedVUs: 100, // Reservar 100 usuarios virtuales.
      stages: [
        { duration: '5m', target: 100 }, // Ramp-up: Incrementar a 100 usuarios concurrentes en 5 minutos.
        { duration: '5m', target: 100 }, // Mantener 100 usuarios concurrentes por 5 minutos.
      ],
      startTime: '12m', // Iniciar después de que terminen los escenarios anteriores (12 minutos).
    },
  },
  thresholds: {
